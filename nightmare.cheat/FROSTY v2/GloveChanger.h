...
void GloveChanger()
{
	...
	if (!g_Engine->GetPlayerInfo(local_id, &localPlayerInfo)) 
		return;
	...
	if (!glove)
	{
...

		{
			static auto set_abs_origin_fn = reinterpret_cast<void(__thiscall*)(void*, const Vector&)>
				(U::FindPattern(U::ClientModule(), (BYTE*)"\x55\x8B\xEC\x83\xE4\xF8\x51\x53\x56\x57\x8B\xF1", "xxxxxxxxxxxx"));
	...
	*reinterpret_cast<int*>(uintptr_t(glove) + 0x64) = -1;
	...
	if (glove)
	{
		...
		{
			if (*glove->fixskins() != 5027 || *glove->FallbackPaintKit() != GetGloveSkinByMenu(0, g_Options.Skinchanger.gloveskin))
			{
		...
		case 2: //Sport Gloves
		{
			if (*glove->fixskins() != 5030 || *glove->FallbackPaintKit() != GetGloveSkinByMenu(1, g_Options.Skinchanger.gloveskin))
			{
		...
		case 3://SLICK GLOVES
		{
			if (*glove->fixskins() != 5031 || *glove->FallbackPaintKit() != GetGloveSkinByMenu(2, g_Options.Skinchanger.gloveskin))
			{
		...
		{
			if (*glove->fixskins() != 5032 || *glove->FallbackPaintKit() != GetGloveSkinByMenu(3, g_Options.Skinchanger.gloveskin))
			{
		...
		{
			if (*glove->fixskins() != 5033 || *glove->FallbackPaintKit() != GetGloveSkinByMenu(4, g_Options.Skinchanger.gloveskin))
			{
		...
		{
			if (*glove->fixskins() != 5034 || *glove->FallbackPaintKit() != GetGloveSkinByMenu(5, g_Options.Skinchanger.gloveskin))
			{
		...
		case 7://HYDRA GLOVES
		{
			if (*glove->fixskins() != 5035 || *glove->FallbackPaintKit() != GetGloveSkinByMenu(6, g_Options.Skinchanger.gloveskin))
			{
