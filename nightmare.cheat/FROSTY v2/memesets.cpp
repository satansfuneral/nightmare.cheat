...
void Offsetz::GetNetvars()
{
	...
	offsetz.FullUpdate = U::FindPatternIDA(("engine.dll"), ("A1 ? ? ? ? B9 ? ? ? ? 56 FF 50 14 8B 34 85"));

	offsetz.m_hActiveWeapon = 0x2EE8;
	...
	offsetz.DT_BaseEntity.m_bIsAutoaimTarget = NetVarManager->GetOffset("DT_BaseEntity", "m_bIsAutoaimTarget");
