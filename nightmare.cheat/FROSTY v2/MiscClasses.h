...
public:
	...
	{
		call_vfunc<void(__thiscall*)(void*, Vector&, Vector&, float&, int, int, int, int, float)>(this, 24)(this, mins, maxs, pillradius, r, g, b, a, duration); //should be 23
	}
};
...
public:
	...
	const char* ButtonCodeToString(ButtonCode_t ButtonCode)
	{
		...
		return call_vfunc<OriginalFn>(this, 40)(this, ButtonCode);
	}
...
public:
	char    pad[12];
	int		m_iPlayer; //12
	short	m_iItemDefinitionIndex; // int
	Vector	m_vecOrigin;
	Vector	m_vecAngles;
	int		m_iWeaponID;
	int		m_iMode;
