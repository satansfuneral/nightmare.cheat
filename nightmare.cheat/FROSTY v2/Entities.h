...
public:
	int m_iMaxClip()
	{
		return *(int*)((DWORD)this + 0x0014);
	}
	int m_iMaxReserved()
	{
		return *(int*)((DWORD)this + 0x0024);
	}
	char* m_cHudName()
	{
		return (char*)((DWORD)this + 0x0088);
	}
	char* m_cWeaponName()
	{
		return (char*)((DWORD)this + 0x008C);
	}
	int m_iType()
	{
		return *(int*)((DWORD)this + 0x00CC);
	}
	int m_iPrice()
	{
		return *(int*)((DWORD)this + 0x00D0);
	}
	int m_iReward()
	{
		return *(int*)((DWORD)this + 0x00D4);
	}
	bool m_bFullAuto()
	{
		return *(bool*)((DWORD)this + 0x00EC);
	}
	int m_iDamage()
	{
		return *(int*)((DWORD)this + 0x00F0);
	}
	float m_fArmorRatio()
	{
		return *(float*)((DWORD)this + 0x00F4);
	}
	int m_iBullets()
	{
		return *(int*)((DWORD)this + 0x00F8);
	}
	float m_fPenetration()
	{
		return *(float*)((DWORD)this + 0x00FC);
	}
	float m_fRange()
	{
		return *(float*)((DWORD)this + 0x0108);
	}
	float m_fRangeModifier()
	{
		return *(float*)((DWORD)this + 0x010C);
	}
	bool m_bHasSilencer()
	{
		return *(bool*)((DWORD)this + 0x0120);
	}
	float m_fMaxSpeed()
	{
		return *(float*)((DWORD)this + 0x0130);
	}
	float m_fMaxSpeedAlt()
	{
		return *(float*)((DWORD)this + 0x0134);
	}
	int m_iRecoilSeed()
	{
		return *(int*)((DWORD)this + 0x0184);
	}
};
...
const std::map<ItemDefinitionIndexx, DefItem_t> ItemDefinitionIndexxMap = {
...
public:
	...
	{
		return (short*)((uintptr_t)this + 0x1EA);
	}
...
public:
	...
	bool IsKnife()
	{
		auto iWeaponID = *this->m_AttributeManager()->m_Item()->ItemDefinitionIndex();
	...
	char* GetGunName()
	{
		auto WeaponId = *this->m_AttributeManager()->m_Item()->ItemDefinitionIndex();
		if (this->IsKnife())
			return "Knife";
		switch (WeaponId)
		{
...
public:
	...
	void SetAbsOrigin(Vector ArgOrigin)
	{
		...
		if (!func)
			func = (Fn)(U::FindPattern(U::ClientModule(), (PBYTE)"\x55\x8B\xEC\x83\xE4\xF8\x51\x53\x56\x57\x8B\xF1\xE8\x00\x00", "xxxxxxxxxxxxx??"));
	...
	int m_iShotsFired()
	{
		return *(int*)((uintptr_t)this + offsetz.DT_CSPlayer.m_iShotsFired);
	}
	bool IsSpotted()
	{
	...
	int GetActiveWeaponIndex() {
		return *reinterpret_cast< int* >(uintptr_t(this) + offsetz.m_hActiveWeapon) & 0xFFF;
	}
	...
	void SetAngle2(Vector wantedang) {
		...
		static oSetAngle _SetAngle = (oSetAngle)((uintptr_t)U::FindSig(U::ClientModule(), "55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1"));
	...
	void UpdateAnimationState(C_CSGOPlayerAnimState *state, QAngle angle)
	{
		if (!state)
			return;

		static auto UpdateAnimState = U::pattern_scan(GetModuleHandleA(U::ClientModule()), "55 8B EC 83 E4 F8 83 EC 18 56 57 8B F9 F3 0F 11 54 24");
	...
	void ResetAnimationState(C_CSGOPlayerAnimState *state)
	{
		if (!state)
			return;
		...
		static auto ResetAnimState = (ResetAnimState_t)U::pattern_scan(GetModuleHandleA(U::ClientModule()), "56 6A 01 68 ? ? ? ? 8B F1");
	...
	{
		using CreateAnimState_t = void(__thiscall*)(C_CSGOPlayerAnimState*, C_BaseEntity*);

		static auto CreateAnimState = (CreateAnimState_t)U::pattern_scan(GetModuleHandleA(U::ClientModule()), "55 8B EC 56 8B F1 B9 ? ? ? ? C7 46");
