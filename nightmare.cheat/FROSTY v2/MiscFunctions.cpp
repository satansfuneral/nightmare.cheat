...
bool TraceToExit(Vector& end, trace_t& tr, Vector start, Vector vEnd, trace_t* trace)
{
	...
	static DWORD TraceToExit = U::FindPattern(U::ClientModule(), (BYTE*)"\x55\x8B\xEC\x83\xEC\x30\xF3\x0F\x10\x75", "xxxxxxxxxx"); // "\x55\x8B\xEC\x83\xEC\x30\xF3\x0F\x10\x75", "xxxxxxxxxx"
...
bool MiscFunctions::IsPlayerValid(C_BaseEntity *entity, C_BaseEntity* local)
{
	if (!entity)
		return false;
